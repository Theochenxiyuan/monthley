  ...
  >
    <el-form>
      ...
      <el-form-item label="名称">
        <el-input v-model="formData.name" placeholder="输入条目名称" />
      </el-form-item>
...
import type { EntryFormData } from '@/types/models';
...
function handleSubmit(formData: EntryFormData): void {
  if (formData.name === '' || formData.type === '' || formData.month === null) {
